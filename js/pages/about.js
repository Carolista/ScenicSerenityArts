...
export function initAboutPage() {
    ...
    'Welcome to Scenic Serenity Arts, where creativity meets tranquility.';

    const paragraph2 = document.createElement('p');
    paragraph2.textContent =
    'Discover our collection of original artwork, prints, and unique merchandise inspired by the beauty of nature and serene landscapes.';
